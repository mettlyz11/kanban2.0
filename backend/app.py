...
# ============================================
try:
    # from monitoring_routes import monitoring_bp, init_monitoring_db  # DISABLED
    # init_monitoring_db(DB_PATH)  # DISABLED
    # app.register_blueprint(monitoring_bp)  # DISABLED
...
# ============================================
try:
    from perception_routes import perception_bp, init_agent as init_perception_agent
...
# ============================================
try:
    from workflow_architecture_routes import workflow_arch_bp
    app.register_blueprint(workflow_arch_bp)
...
# ============================================
try:
    from person_company_routes import person_company_bp, init_person_company_tables
    app.register_blueprint(person_company_bp)
    init_person_company_tables()
