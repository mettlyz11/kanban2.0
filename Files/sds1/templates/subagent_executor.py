...
try:
    ...
    # 使用Superpowers分析结果作为后续执行的基础
    output_format = "文档"  # 默认产出格式
    if "代码" in task_type or "开发" in task_type:
        output_format = "代码"
    elif "收集" in task_type or "文件" in task_type:
        output_format = "压缩包"
