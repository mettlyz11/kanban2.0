...
"""
    ...
    attachments = [
        ('SDS_告警推送系统实现报告_2026-04-23.md', '设计与实现报告', 'md'),
        ('sds_alert_engine.py', '告警引擎完整实现代码', 'py'),
    ]

    for filename, desc, ftype in attachments:
        ...
        if os.path.exists(filepath):
            ...
            cursor.execute(
                ...
                ('task', task_id, filename, f'output/task-1725/{filename}', size, ftype, desc)
            )
