...
class RateLimitLayer:
    ...
    def __init__(self, max_tasks: int = None, max_pending: int = None,
        ...
        self.max_tasks = max_tasks or self.DEFAULT_MAX_TASKS_PER_24H
        self.max_pending = max_pending or self.DEFAULT_MAX_PENDING_PER_GOAL
        self.window_hours = window_hours or self.DEFAULT_WINDOW_HOURS
...
class SemanticDedupLayer:
    ...
    def __init__(self, prefix_length: int = None, similarity_threshold: float = None):
        self.prefix_length = prefix_length or self.DEFAULT_PREFIX_LENGTH
