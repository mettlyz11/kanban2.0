...
export function XiaBoshi() {
  ...
  const fetchDetail = async () => {
    try {
      const res = await fetch('/api/personal-info/xiaboshi')
    ...
    <div className="page-container">
      ...
      {activeTab === 'files' && (
        <div className="card">
          ...
          <ProfileFromFiles type="personal" name="xiaboshi" showTabs={true} />
        </div>
      )}
    </div>
  )
