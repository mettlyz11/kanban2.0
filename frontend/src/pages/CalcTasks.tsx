export function CalcTasks() {
  ...
  const t109Links = [
    ...
    { name: '查看计算结果', url: 'https://t109.mettlyz.com/results', desc: '查看已完成的计算任务结果', icon: '📊' },
    { name: '任务队列', url: 'https://t109.mettlyz.com/queue', desc: '查看当前运行中的任务队列', icon: '⏳' },
    { name: '用户面板', url: 'https://t109.mettlyz.com/dashboard', desc: '查看个人任务统计和信息', icon: '👤' },
  ]
